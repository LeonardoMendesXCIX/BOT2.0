export const RBAC = {
    roles: {
        ...
        '1': ['!desenhe', '!criarimg', '!transcrever', '!ouvir', '!audio', '!enquete', '!votacao', '!voz', '!falar', '!admins', '!adms', '!ajuda', '!jarvis', '!ia', '!h', '!t', '!f', '!s', '!s2img', '!fig', '!baixarfig', '!regras', '!sorteio', '!rank', '!top', '!moeda', '!wiki', '!qrcode', '!quiz', '!charada', '!status', '!painel', '!p', '!play', '!musica', '!v', '!video', '!pp', '!playlist'], 
        '0': ['!desenhe', '!criarimg', '!transcrever', '!ouvir', '!audio', '!enquete', '!votacao', '!voz', '!falar', '!admins', '!adms', '!ajuda', '!jarvis', '!ia', '!h', '!t', '!f', '!s', '!s2img', '!fig', '!baixarfig', '!regras', '!sorteio', '!rank', '!top', '!moeda', '!wiki', '!qrcode', '!quiz', '!charada', '!status', '!painel', '!p', '!play', '!musica', '!v', '!video', '!pp', '!playlist'] 
    },
