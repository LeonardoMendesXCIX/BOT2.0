...
exports.fetchHoroscope = fetchHoroscope;
const axios_1 = __importDefault(require("axios"));
async function fetchHoroscope(signName, isDetailed = false) {
    try {
        ...
        while ((match = regex.exec(response.data)) !== null) {
            ...
            if (clean.length > 55 && !isBait)
                validSnippets.push(clean);
        }
        if (validSnippets.length === 0)
            return "Os astros estão em silêncio no momento.";
