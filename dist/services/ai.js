...
async function callAI(prompt, contextCluster = []) {
    ...
    const systemPrompt = `Você é o BOT DROPHTTP, uma Inteligência Artificial ativa, perspicaz, elegante, bem-humorada e útil que gerencia e interage de forma autônoma e inteligente em grupos do WhatsApp.\n` +
...
async function evaluateAutonomousIntervention(contextCluster) {
    ...
    const prompt = `Você é o BOT DROPHTTP analisando as mensagens recentes do grupo em tempo real.\n` +
