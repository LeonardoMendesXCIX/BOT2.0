...
exports.generateNglCard = generateNglCard;
exports.generateProfileCard = generateProfileCard;
exports.generateMemeCard = generateMemeCard;
exports.generateQuoteCard = generateQuoteCard;
...
async function generateNglCard(message, footer) {
    ...
    const svg = '<svg width="720" height="' + totalH + '" xmlns="http://www.w3.org/2000/svg">' +
        ...
        '</svg>';
    return await (0, sharp_1.default)(Buffer.from(svg)).png().toBuffer();
}
async function generateProfileCard(name, level, role, xp, coins) {
...
async function generateMemeCard(top, bottom) {
...
async function generateQuoteCard(author, quote) {
...
async function generateTextSticker(text, bg) {
